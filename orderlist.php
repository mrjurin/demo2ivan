            ...
            <th>Agent code</th>
               ...
               <tbody>
                  ...
                  <tr  data-id="<?php echo $row['id']; ?>" class="<?php echo $todayorder; ?> <?php echo $callss; ?> br_bk" >
                    ...
                    <td><a href="<?php echo $site_url; ?>/view_merchant.php?sid=<?php echo $merchant_name['mobile_number'];?>&oid=<?php echo $row['id']; ?>"><?php echo $merchant_name['name'];  ?></td>
                        <!--  -->
						<td>
                       <?php
                        $status = $row['status'];
                        ...
                        ?>
                        <label class= "btn btn-primary status" data-id="<?php echo $row['id']; ?>" style="cursor:pointer;"> <?php echo $sta; ?></label>
                     </td> 
					 <td class="s_order_detail btn btn-blue" order_id='<?php echo $row['id']; ?>'> Detail</td>
					...
					<td><?php if($row['varient_type']){$v_str=$row['varient_type'];
					 ...
					 <td class="amount_<?php echo $row['id'];?>">
							...
							<td><?php echo @number_format($row['total_cart_amount']-$row['membership_discount']-$row['coupon_discount'],2); ?></td>
