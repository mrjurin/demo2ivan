...
error_reporting(0);
$conn = mysqli_connect("localhost", "koofamil_demo2", "+Rhe!jE8WcV7", "koofamil_demo2");
// $conn = mysqli_connect("localhost", "koofamil_demo2", "", "koofamil_B277");
...
$site_url = "https://koofamilies.com/";   // Prod // Prod     
// $site_url = "http://localhost/livecode/";   // Prod // Prod     
// $paypalUrl='https://www.sandbox.paypal.com/cgi-bin/webscr';
