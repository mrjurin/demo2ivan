        ...
        <div class="content-wrapper">
            ...
            <main class="main-wrapper clearfix" style="min-height: 522px;">
                <div class="container-fluid" id="main-content" style="padding-top:25px">
					<h2 class="text-center wallet_h">Accepting Partner List</h2>
								...
								<div class="form-group">
									<?php 
									 ...
									 if($_POST['choose_agent'])
									 {
										...
										on u.id=c.user_id and c.merchant_id='$m_id' and c.status='1' where u.user_roles='2' and u.name!='' and u.special_coin_name!=''  order by u.name asc";
					...
					<form method="post" id="form1" action="update_apartner.php">
