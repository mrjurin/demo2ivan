...
<nav class="sidebar-nav">
    <ul class="nav in side-menu">
        <li class="menu-item-has-children">
		  ...
		  <li><a href="apartnerlist.php"><span class="hide-menu">Accepting Coin Partner</span></a></li>   
		  <li><a href="partnerlist.php"><span class="hide-menu">Associated  Partner List</span></a></li>   
        <li><a href="agents.php"><span class="hide-menu">Agents</span></a></li>   
