								...
								<div style="display:none;margin-left: 89px;margin-top: 16px;" id="merchantoptionset">
                                 ...
                                 <br>
                                    ...
                                    <div class="login-bottom login-bottom1">
                                        <div class="submit">
                                            <input type="submit" value="<?php echo $language["login"];?>" name="login" class="submint_login" style="padding:14px;margin-top: -40px;background: #51d2b7;color: white;border: #51d2b7;" />
                                        </div>
