...
if(isset($_GET['q']) && $_GET['q'] == 'getNumAgentTransactions'){
  ...
  $u_id = mysqli_fetch_assoc(mysqli_query($conn, "SELECT id FROM users WHERE mobile_number = '$mobile_phone'"))['id'];
...
$start_url=$site_url."/structure_merchant.php?sid=".$merchant_detail['id'];
?>
<script>
